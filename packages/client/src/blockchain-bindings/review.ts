...
export interface IReview {
    create(data: ReviewDetails, serviceId: string, userId: string): Promise<ClientTransactionResponse>;
}
...
export class Review {
    ...
    public async create(data: ReviewDetails, serviceId: string, userId: string): Promise<ClientTransactionResponse> {
